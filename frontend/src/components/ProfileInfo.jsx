...
const ProfileInfo = () => {
  const userProfile = {
    ...
    bio: "Final Year Engineering Student || Development & DevOps. 👨🏻‍💻👨🏻‍💻👨🏻‍💻",
    email: "anmol.28422@gmail.com",
    followers: 9,
    following: 21,
    html_url: "https://github.com/AnmolShukla2002",
    location: "Kanpur, Uttar Pradesh",
    name: "Anmol Shukla",
    public_gists: 50,
    public_repos: 28,
    twitter_username: "bunny_782",
    login: "AnmolShukla2002",
  };
